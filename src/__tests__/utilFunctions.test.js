...
test('shortenText should not alter a string with fewer than 100 characters', () => {
    expect(shortenText(shortText)).toHaveLength(29)
})

test('shortenText should cutt off extra characters after 100 and add and elipses', () => {
